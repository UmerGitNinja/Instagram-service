...
const Getstarted = [
  {
    ...
    icon: "/Images/instagram-step-1.png",
  },
  {
    ...
    icon: "/Images/instagram-step-2.png",
  },
  {
    ...
    icon: "/Images/instagram-step-3.png",
  },
];
const GetStartedComponent = () => {
  return (
    <section className="flex flex-col gap-8 py-16 justify-center items-center ">
      ...
      <a
        href="#"
        className="py-4 px-8 mt-16 !rounded-full sm:px-16 sm:py-6 tracking-normal !text-white font-bold sm:text-xl bg-gradient-to-r from-[#735fd1] to-[#DB447E] "
      >
        Grow My Instagram
      </a>
    </section>
